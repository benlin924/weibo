...
<head>
    ...
    <title>后盾微博-首页</title>
    <link rel="stylesheet" href="/weibo/Public/Css/comment.css" />
            ...
            <div class='top_wrap'>
                ...
                <ul class='top_right fleft'>
                    ...
                    <li class='selector'><i class='icon icon-setup'></i>
                        <ul class='hidden' style="z-index: 20">
...
<?php if(!$res): ?>没有发布的微博
<?php else: ?>
<?php if(is_array($res)): foreach($res as $key=>$v): if(!$v["isturn"]): ?><!--====================普通微博样式====================-->
            <div class="weibo">
                <!--头像-->
                <div class="face">
...
<!--====================转发样式====================-->
            ...
            <!--头像-->
                ...
                <div class="wb_cons">
                    ...
                    <!--发布内容-->
                        <dd class='content'>
                            <p><?php echo (str_replace('//', '<span style="color:#ccc;font-weight:bold;">&nbsp;//&nbsp;</span>', $v["content"])); ?></p>
                        </dd>
                    <!--转发的微博内容-->
                        <dd>
                            <div class="wb_turn">
